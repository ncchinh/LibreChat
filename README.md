...
- **Attached workspaces (highly experimental):** Agents can inspect workspace trees, read and search files, author changes, and run Bash through managed or personal code workers. Personal workers support bounded self-service enrollment, readiness status, and per-Agent Git identity.
